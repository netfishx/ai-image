...
import { CommonHeader } from "@/app/common-header";
...
export default function Personal() {
  return (
    <>
      ...
      >
        <div
          className="flex flex-col gap-4 rounded-lg bg-background bg-cover p-4"
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="secondary"
              className="rounded-full bg-amber-500 text-lg"
              size="lg"
            >
              成为VIP
            </Button>
        ...
        <div className="grid grid-cols-3 gap-2 text-white *:flex *:aspect-square *:flex-col *:items-center *:justify-center *:gap-2 *:rounded-lg *:bg-slate-800 *:p-4">
          <Link href="#">
            <Share2 />
            分享推广
          </Link>
        ...
        <div className="flex flex-col items-center justify-center pt-8 text-sm text-white">
